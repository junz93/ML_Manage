...
public class SocketConnectorHandler extends IoHandlerAdapter  {  
	...
	public static String TcpExceptionSessionIP = null;
	    ...
	    public void sessionClosed(IoSession session) {
	        ...
	        //从保存的通道中删除
//	        System.out.println("11111111map.size():    前"+ MsgQueueMgr.getDest_session().size());
...
//	        System.out.println("11111111map.size():    后"+map.size());
...
//	        //关闭连接
	    ...
	    public void sessionIdle(IoSession session, IdleStatus status) {
	    	System.out.println("********** sessionSEDDDDDDD idle *********");
	    	session.getService().dispose();
